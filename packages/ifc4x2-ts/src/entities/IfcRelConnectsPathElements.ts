...
import { IfcInteger, IfcConnectionTypeEnum, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
 ...
 */
 class IfcRelConnectsPathElements extends IfcRelConnectsElements {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, ConnectionGeometry:IfcConnectionGeometry, RelatingElement:IfcElement, RelatedElement:IfcElement, RelatingPriorities:Array<IfcInteger>, RelatedPriorities:Array<IfcInteger>, RelatedConnectionType:IfcConnectionTypeEnum, RelatingConnectionType:IfcConnectionTypeEnum) {
