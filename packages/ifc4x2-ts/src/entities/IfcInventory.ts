...
import { IfcInventoryTypeEnum, IfcActorSelect, IfcDate, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
import { IfcPerson, IfcCostValue, IfcOwnerHistory, IfcGroup } from './'
 ...
 */
 class IfcInventory extends IfcGroup {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, ObjectType:IfcLabel, PredefinedType:IfcInventoryTypeEnum, Jurisdiction:IfcActorSelect, ResponsiblePersons:Array<IfcPerson>, LastUpdateDate:IfcDate, CurrentValue:IfcCostValue, OriginalValue:IfcCostValue) {
