...
import { IfcGridAxis, IfcOwnerHistory, IfcObjectPlacement, IfcProductRepresentation, IfcPositioningElement } from './'
import { IfcGridTypeEnum, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
 ...
 */
 class IfcGrid extends IfcPositioningElement {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, ObjectType:IfcLabel, ObjectPlacement:IfcObjectPlacement, Representation:IfcProductRepresentation, UAxes:Array<IfcGridAxis>, VAxes:Array<IfcGridAxis>, WAxes:Array<IfcGridAxis>, PredefinedType:IfcGridTypeEnum) {
