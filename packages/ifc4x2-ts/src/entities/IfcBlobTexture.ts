...
import { IfcIdentifier, IfcBinary, IfcBoolean } from '../types'
 ...
 */
 class IfcBlobTexture extends IfcSurfaceTexture {
    constructor(RepeatS:IfcBoolean, RepeatT:IfcBoolean, Mode:IfcIdentifier, TextureTransform:IfcCartesianTransformationOperator2D, Parameter:Array<IfcIdentifier>, RasterFormat:IfcIdentifier, RasterCode:IfcBinary) {
