...
import { IfcGloballyUniqueId, IfcLabel, IfcText, IfcStructuralSurfaceMemberTypeEnum, IfcPositiveLengthMeasure } from '../types'
import { IfcOwnerHistory, IfcObjectPlacement, IfcProductRepresentation, IfcStructuralSurfaceMember } from './'
 ...
 */
 class IfcStructuralSurfaceMemberVarying extends IfcStructuralSurfaceMember {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, ObjectType:IfcLabel, ObjectPlacement:IfcObjectPlacement, Representation:IfcProductRepresentation, PredefinedType:IfcStructuralSurfaceMemberTypeEnum, Thickness:IfcPositiveLengthMeasure) {
