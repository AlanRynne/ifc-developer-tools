...
import { IfcSystem, IfcSpatialElement, IfcOwnerHistory, IfcRelConnects } from './'
 ...
 */
 class IfcRelServicesBuildings extends IfcRelConnects {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, RelatingSystem:IfcSystem, RelatedBuildings:Array<IfcSpatialElement>) {
