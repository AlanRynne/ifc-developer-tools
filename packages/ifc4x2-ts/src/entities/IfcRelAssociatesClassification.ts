...
import { IfcClassificationSelect, IfcGloballyUniqueId, IfcLabel, IfcText, IfcDefinitionSelect } from '../types'
 ...
 */
 class IfcRelAssociatesClassification extends IfcRelAssociates {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, RelatedObjects:Array<IfcDefinitionSelect>, RelatingClassification:IfcClassificationSelect) {
