...
import { IfcIdentifier, IfcActorSelect, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
import { IfcCostValue, IfcPerson, IfcCalendarDate, IfcOwnerHistory, IfcGroup } from './'
 ...
 */
 class IfcAsset extends IfcGroup {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, ObjectType:IfcLabel, AssetID:IfcIdentifier, OriginalValue:IfcCostValue, CurrentValue:IfcCostValue, TotalReplacementCost:IfcCostValue, Owner:IfcActorSelect, User:IfcActorSelect, ResponsiblePerson:IfcPerson, IncorporationDate:IfcCalendarDate, DepreciatedValue:IfcCostValue) {
