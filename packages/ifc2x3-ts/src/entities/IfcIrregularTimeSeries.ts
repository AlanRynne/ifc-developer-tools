...
import { IfcLabel, IfcText, IfcDateTimeSelect, IfcTimeSeriesDataTypeEnum, IfcDataOriginEnum, IfcUnit } from '../types'
 ...
 */
 class IfcIrregularTimeSeries extends IfcTimeSeries {
    constructor(Name:IfcLabel, Description:IfcText, StartTime:IfcDateTimeSelect, EndTime:IfcDateTimeSelect, TimeSeriesDataType:IfcTimeSeriesDataTypeEnum, DataOrigin:IfcDataOriginEnum, UserDefinedDataOrigin:IfcLabel, Unit:IfcUnit, Values:Array<IfcIrregularTimeSeriesValue>) {
