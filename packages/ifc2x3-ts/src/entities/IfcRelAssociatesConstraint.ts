...
import { IfcConstraint, IfcOwnerHistory, IfcRoot, IfcRelAssociates } from './'
 ...
 */
 class IfcRelAssociatesConstraint extends IfcRelAssociates {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, RelatedObjects:Array<IfcRoot>, Intent:IfcLabel, RelatingConstraint:IfcConstraint) {
