...
import { IfcLibrarySelect, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
 ...
 */
 class IfcRelAssociatesLibrary extends IfcRelAssociates {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, RelatedObjects:Array<IfcRoot>, RelatingLibrary:IfcLibrarySelect) {
