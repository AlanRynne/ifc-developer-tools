...
import { IfcAssemblyPlaceEnum, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
 ...
 */
 class IfcFurnitureType extends IfcFurnishingElementType {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, ApplicableOccurrence:IfcLabel, HasPropertySets:Array<IfcPropertySetDefinition>, RepresentationMaps:Array<IfcRepresentationMap>, Tag:IfcLabel, ElementType:IfcLabel, AssemblyPlace:IfcAssemblyPlaceEnum) {
