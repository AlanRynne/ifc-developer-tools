 ...
 */
 class IfcPerson  {
    constructor(Id:IfcIdentifier, FamilyName:IfcLabel, GivenName:IfcLabel, MiddleNames:Array<IfcLabel>, PrefixTitles:Array<IfcLabel>, SuffixTitles:Array<IfcLabel>, Roles:Array<IfcActorRole>, Addresses:Array<IfcAddress>) {
