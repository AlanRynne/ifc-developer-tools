...
import { IfcWindowStyleConstructionEnum, IfcWindowStyleOperationEnum, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
 ...
 */
 class IfcWindowStyle extends IfcTypeProduct {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, ApplicableOccurrence:IfcLabel, HasPropertySets:Array<IfcPropertySetDefinition>, RepresentationMaps:Array<IfcRepresentationMap>, Tag:IfcLabel, ConstructionType:IfcWindowStyleConstructionEnum, OperationType:IfcWindowStyleOperationEnum, ParameterTakesPrecedence:boolean, Sizeable:boolean) {
