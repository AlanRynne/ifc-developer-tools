...
import { IfcPositiveLengthMeasure, IfcNormalisedRatioMeasure, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
 ...
 */
 class IfcWindowLiningProperties extends IfcPropertySetDefinition {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, LiningDepth:IfcPositiveLengthMeasure, LiningThickness:IfcPositiveLengthMeasure, TransomThickness:IfcPositiveLengthMeasure, MullionThickness:IfcPositiveLengthMeasure, FirstTransomOffset:IfcNormalisedRatioMeasure, SecondTransomOffset:IfcNormalisedRatioMeasure, FirstMullionOffset:IfcNormalisedRatioMeasure, SecondMullionOffset:IfcNormalisedRatioMeasure, ShapeAspectStyle:IfcShapeAspect) {
