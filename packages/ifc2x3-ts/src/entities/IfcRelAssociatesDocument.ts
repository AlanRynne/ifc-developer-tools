...
import { IfcDocumentSelect, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
 ...
 */
 class IfcRelAssociatesDocument extends IfcRelAssociates {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, RelatedObjects:Array<IfcRoot>, RelatingDocument:IfcDocumentSelect) {
