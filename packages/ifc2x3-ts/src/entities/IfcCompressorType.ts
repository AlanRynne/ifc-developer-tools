...
import { IfcCompressorTypeEnum, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
 ...
 */
 class IfcCompressorType extends IfcFlowMovingDeviceType {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, ApplicableOccurrence:IfcLabel, HasPropertySets:Array<IfcPropertySetDefinition>, RepresentationMaps:Array<IfcRepresentationMap>, Tag:IfcLabel, ElementType:IfcLabel, PredefinedType:IfcCompressorTypeEnum) {
