 ...
 */
 class IfcRectangleHollowProfileDef extends IfcRectangleProfileDef {
    constructor(ProfileType:IfcProfileTypeEnum, ProfileName:IfcLabel, Position:IfcAxis2Placement2D, XDim:IfcPositiveLengthMeasure, YDim:IfcPositiveLengthMeasure, WallThickness:IfcPositiveLengthMeasure, InnerFilletRadius:IfcPositiveLengthMeasure, OuterFilletRadius:IfcPositiveLengthMeasure) {
