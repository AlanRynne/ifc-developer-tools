...
import { IfcLabel, IfcObjectReferenceSelect, IfcIdentifier, IfcText } from '../types'
 ...
 */
 class IfcPropertyReferenceValue extends IfcSimpleProperty {
    constructor(Name:IfcIdentifier, Description:IfcText, UsageName:IfcLabel, PropertyReference:IfcObjectReferenceSelect) {
