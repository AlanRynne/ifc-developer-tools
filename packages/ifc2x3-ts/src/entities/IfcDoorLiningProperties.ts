...
import { IfcPositiveLengthMeasure, IfcLengthMeasure, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
 ...
 */
 class IfcDoorLiningProperties extends IfcPropertySetDefinition {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, LiningDepth:IfcPositiveLengthMeasure, LiningThickness:IfcPositiveLengthMeasure, ThresholdDepth:IfcPositiveLengthMeasure, ThresholdThickness:IfcPositiveLengthMeasure, TransomThickness:IfcPositiveLengthMeasure, TransomOffset:IfcLengthMeasure, LiningOffset:IfcLengthMeasure, ThresholdOffset:IfcLengthMeasure, CasingThickness:IfcPositiveLengthMeasure, CasingDepth:IfcPositiveLengthMeasure, ShapeAspectStyle:IfcShapeAspect) {
