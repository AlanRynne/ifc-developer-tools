...
import { IfcTimeMeasure, IfcLabel, IfcText, IfcDateTimeSelect, IfcTimeSeriesDataTypeEnum, IfcDataOriginEnum, IfcUnit } from '../types'
 ...
 */
 class IfcRegularTimeSeries extends IfcTimeSeries {
    constructor(Name:IfcLabel, Description:IfcText, StartTime:IfcDateTimeSelect, EndTime:IfcDateTimeSelect, TimeSeriesDataType:IfcTimeSeriesDataTypeEnum, DataOrigin:IfcDataOriginEnum, UserDefinedDataOrigin:IfcLabel, Unit:IfcUnit, TimeStep:IfcTimeMeasure, Values:Array<IfcTimeSeriesValue>) {
