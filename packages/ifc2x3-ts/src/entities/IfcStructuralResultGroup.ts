...
import { IfcAnalysisTheoryTypeEnum, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
 ...
 */
 class IfcStructuralResultGroup extends IfcGroup {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, ObjectType:IfcLabel, TheoryType:IfcAnalysisTheoryTypeEnum, ResultForLoadGroup:IfcStructuralLoadGroup, IsLinear:boolean) {
