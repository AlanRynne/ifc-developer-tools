...
import { IfcDoorStyleOperationEnum, IfcDoorStyleConstructionEnum, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
 ...
 */
 class IfcDoorStyle extends IfcTypeProduct {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, ApplicableOccurrence:IfcLabel, HasPropertySets:Array<IfcPropertySetDefinition>, RepresentationMaps:Array<IfcRepresentationMap>, Tag:IfcLabel, OperationType:IfcDoorStyleOperationEnum, ConstructionType:IfcDoorStyleConstructionEnum, ParameterTakesPrecedence:boolean, Sizeable:boolean) {
