...
import { IfcSpace, IfcElement, IfcConnectionGeometry, IfcOwnerHistory, IfcRelConnects } from './'
import { IfcPhysicalOrVirtualEnum, IfcInternalOrExternalEnum, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
 ...
 */
 class IfcRelSpaceBoundary extends IfcRelConnects {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, RelatingSpace:IfcSpace, RelatedBuildingElement:IfcElement, ConnectionGeometry:IfcConnectionGeometry, PhysicalOrVirtualBoundary:IfcPhysicalOrVirtualEnum, InternalOrExternalBoundary:IfcInternalOrExternalEnum) {
