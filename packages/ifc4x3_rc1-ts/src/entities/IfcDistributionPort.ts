...
import { IfcFlowDirectionEnum, IfcDistributionPortTypeEnum, IfcDistributionSystemEnum, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
 ...
 */
 class IfcDistributionPort extends IfcPort {
    ...
    */
    ...
    /** Enumeration that identifies the system type.
     * If a system type is defined, the port may only be connected to other ports having the same system type.
    */
    SystemType?: IfcDistributionSystemEnum
}
