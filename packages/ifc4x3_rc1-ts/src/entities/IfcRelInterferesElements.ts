...
import { IfcInterferenceSelect, IfcIdentifier, IfcLogical, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
import { IfcConnectionGeometry, IfcOwnerHistory, IfcRelConnects } from './'
 ...
 */
 class IfcRelInterferesElements extends IfcRelConnects {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, RelatingElement:IfcInterferenceSelect, RelatedElement:IfcInterferenceSelect, InterferenceGeometry:IfcConnectionGeometry, InterferenceType:IfcIdentifier, ImpliedOrder:IfcLogical) {
