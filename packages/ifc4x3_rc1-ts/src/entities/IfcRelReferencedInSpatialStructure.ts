...
import { IfcSpatialReferenceSelect, IfcGloballyUniqueId, IfcLabel, IfcText } from '../types'
import { IfcSpatialElement, IfcOwnerHistory, IfcRelConnects } from './'
 ...
 */
 class IfcRelReferencedInSpatialStructure extends IfcRelConnects {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, RelatedElements:Array<IfcSpatialReferenceSelect>, RelatingStructure:IfcSpatialElement) {
    ...
    */
    RelatedElements: Array<IfcSpatialReferenceSelect>
