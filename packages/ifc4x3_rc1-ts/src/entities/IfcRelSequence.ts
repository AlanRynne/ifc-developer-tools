...
import { IfcProcess, IfcLagTime, IfcOwnerHistory, IfcRelConnects } from './'
import { IfcSequenceEnum, IfcLabel, IfcGloballyUniqueId, IfcText } from '../types'
 ...
 */
 class IfcRelSequence extends IfcRelConnects {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, RelatingProcess:IfcProcess, RelatedProcess:IfcProcess, TimeLag:IfcLagTime, SequenceType:IfcSequenceEnum, UserDefinedSequenceType:IfcLabel) {
    ...
    */
    ...
    /** Allows for specification of user defined type of the sequence beyond the enumeration values (START_START, START_FINISH, FINISH_START, FINISH_FINISH) provided by SequenceType attribute of type IfcSequenceEnum.
     * When a value is provided for attribute UserDefinedSequenceType in parallel the attribute SequenceType shall have enumeration value USERDEFINED.
