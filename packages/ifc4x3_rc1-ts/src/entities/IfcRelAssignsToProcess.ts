...
import { IfcProcessSelect, IfcGloballyUniqueId, IfcLabel, IfcText, IfcObjectTypeEnum } from '../types'
import { IfcMeasureWithUnit, IfcOwnerHistory, IfcObjectDefinition, IfcRelAssigns } from './'
 ...
 */
 class IfcRelAssignsToProcess extends IfcRelAssigns {
    constructor(GlobalId:IfcGloballyUniqueId, OwnerHistory:IfcOwnerHistory, Name:IfcLabel, Description:IfcText, RelatedObjects:Array<IfcObjectDefinition>, RelatedObjectsType:IfcObjectTypeEnum, RelatingProcess:IfcProcessSelect, QuantityInProcess:IfcMeasureWithUnit) {
