...
import { IfcDocumentInformation, IfcResourceLevelRelationship } from './'
 ...
 */
 class IfcDocumentInformationRelationship extends IfcResourceLevelRelationship {
    constructor(Name:IfcLabel, Description:IfcText, RelatingDocument:IfcDocumentInformation, RelatedDocuments:Array<IfcDocumentInformation>, RelationshipType:IfcLabel) {
