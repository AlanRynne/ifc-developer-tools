...
import { IfcValue, IfcText, IfcUnit, IfcCurveInterpolationEnum, IfcIdentifier } from '../types'
 ...
 */
 class IfcPropertyTableValue extends IfcSimpleProperty {
    constructor(Name:IfcIdentifier, Description:IfcText, DefiningValues:Array<IfcValue>, DefinedValues:Array<IfcValue>, Expression:IfcText, DefiningUnit:IfcUnit, DefinedUnit:IfcUnit, CurveInterpolation:IfcCurveInterpolationEnum) {
    ...
    */
    DefinedUnit?: IfcUnit
    /** Interpolation of the curve between two defining and defined values that are provided.
     * if not provided a linear interpolation is assumed.
